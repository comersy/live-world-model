...
D_LR = 2e-4          # discriminator LR (kept lower so D doesn't overpower G)
ADV_WEIGHT = 0.05    # weight of the adversarial term (small! MSE dominates)
TF_CHUNK = 20
ROLLOUT_EVERY = 3
ROLLOUT_LEN = 12
SEED = 0
...
def main():
    ...
    for epoch in range(EPOCHS):
        ...
        while t < T - 1:
            ...
            adv = bce(D(prev, pred), torch.ones_like(real_logit))  # fool D
